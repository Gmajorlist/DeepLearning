...
from tensorflow.keras.layers import Dense, Input, Dropout, Conv2D, Flatten, SimpleRNN, LSTM, GRU,BatchNormalization,MaxPooling2D
...
x_predict=split_x(x_predict, 4) # (7, 4)
...
x_predict=x_predict.reshape(-1, 4, 1, 1) 
...
model.fit(x_train, y_train, epochs=100, batch_size=32, validation_split=0.2, verbose=3, callbacks=[es])
